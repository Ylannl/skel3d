...
def view(ma, vids):
    ...
    graphs = ma.D['ma_clusters']
    

    # vertex_clustering = g.clusters()
    # import ipdb;ipdb.set_trace()
    for that_id in [222]:
        this_g = graphs[that_id]
        contract_edges(this_g, contract_thres)
...
if __name__ == '__main__':
    ...
    if len(sys.argv)>1:
        ...
        INFILE = sys.argv[-1]
    # import ipdb;ipdb.set_trace()
    INFILE = "/Users/ravi/Sync/Phd/data/mat_samples/vrijstaande_huizen_mixed_npy/"
