...
if __name__ == '__main__':
	...
	parser.add_argument('-c', '--mincount', help='Minimum number of points in a segment', default=10, type=int)
	parser.add_argument('-m', '--method', help='First region growing criterion to use', default='bisecavg', type=str)
